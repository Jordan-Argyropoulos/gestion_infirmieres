...
<form class="box" action="./php/register.php" method="post" >
   ...
   <input type="number" class="box-input" name="numero_inami" placeholder="Numéro Inami" required />
   ...
   <input type="tel" class="box-input" name="numero_telephone" placeholder="Numéro de téléphone" required />
   <input type="text" class="box-input" name="rue" placeholder="Rue" required />
   <input type="text" class="box-input" name="ville" placeholder="Ville" required />
   <input type="number" class="box-input" name="code_postal" placeholder="Code postal" required />
